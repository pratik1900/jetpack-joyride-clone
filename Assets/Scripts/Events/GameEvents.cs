...
public static class GameEvents
{
    ...
    public static event Action<int> OnUpdateScoreMultiplier;
    ...
    public static void TriggerUpdateScoreMultiplier(int multiplier) =>
        OnUpdateScoreMultiplier?.Invoke(multiplier);
}
